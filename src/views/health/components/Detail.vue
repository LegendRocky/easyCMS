          ...
          <el-col :span="24">
            ...
            <div class="postInfo-container">
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item :label-width="labelWidth" label="紧急联系人：">
                    <el-input
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item :label-width="labelWidth" label="紧急联系电话：">
                    <el-input
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item :label-width="labelWidth" label="电话号码：">
                    <el-input
                ...
                <el-col :span="12">
                  <el-form-item :label-width="labelWidth" label="关系：">
                    <el-input
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item :label-width="labelWidth" label="紧急联系地址：">
                    <el-input
